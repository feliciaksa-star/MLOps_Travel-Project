...
mlflow.set_experiment("tourism_project_production_experiment")
...
numeric_features = ["Age", "DurationOfPitch", "NumberOfPersonVisiting", "NumberOfFollowups", "NumberOfTrips", "PitchSatisfactionScore", "NumberOfChildrenVisiting", "MonthlyIncome"]
